...
public class PersistenceController {
    ...
    public static GraphAL<Airport, Flight> getInitialGraph() {
        ...
        Flight f1 = new Flight("CA101", "Air China", 50, LocalTime.of(8, 0), LocalTime.of(12, 0));
        Flight f2 = new Flight("UA200", "United Airlines", 40, LocalTime.of(14, 0), LocalTime.of(16, 0));
        Flight f3 = new Flight("AF300", "Air France", 20,  LocalTime.of(10, 0), LocalTime.of(18, 0));
        Flight f4 = new Flight("BA400", "British Airways", 60, LocalTime.of(9, 0), LocalTime.of(17, 0));
        Flight f5 = new Flight("JL500", "Japan Airlines", 70, LocalTime.of(7, 0), LocalTime.of(13, 0));
        Flight f6 = new Flight("QF600", "Qantas", 40, LocalTime.of(12, 0), LocalTime.of(22, 0));
        Flight f7 = new Flight("EK700", "Emirates", 50, LocalTime.of(15, 0), LocalTime.of(20, 0));
        Flight f8 = new Flight("LA800", "LATAM", 100, LocalTime.of(11, 0), LocalTime.of(21, 0));
        Flight f9 = new Flight("AA900", "American Airlines", 60, LocalTime.of(16, 0), LocalTime.of(22, 0));
        Flight f10 = new Flight("DL1000", "Delta Airlines", 45, LocalTime.of(6, 0), LocalTime.of(10, 0));
